/*!
 * matter 0.14.2 by @liabru 2019-12-15
...
(function() {
    ...
    var _initProperties = function(body, options) {
        ...
        body.render.renderText = options.renderText;
    };
    ...
    Render.bodies = function(render, bodies, context) {
        ...
        for (i = 0; i < bodies.length; i++) {
            ...
            for (k = body.parts.length > 1 ? 1 : 0; k < body.parts.length; k++) {
                ...
                console.log(part.render.renderText);
                //Here's the custom part
                if(part.render.renderText.text) {
                    ...
                    if(part.render.renderText.text.size)
                        fontsize = part.render.renderText.text.size;
                    else if(part.circleRadius)
                        fontsize = part.circleRadius/2;

                    var content = "";
                    if(typeof part.render.text == "string")
                        content = part.render.renderText.text;
                    else if(part.render.renderText.text.content)
                        content = part.render.renderText.text.content;
